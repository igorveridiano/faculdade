...
public class TelaVoto extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnCalculo.setFont(new java.awt.Font("Times New Roman", 0, 14)); // NOI18N
        btnCalculo.setText("Verficar situação de voto");
        ...
        lblIdade.setFont(new java.awt.Font("Times New Roman", 0, 14)); // NOI18N
        lblIdade.setText("0");

        lblSituacao.setFont(new java.awt.Font("Times New Roman", 0, 14)); // NOI18N
    ...
    private void btnCalculoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCalculoActionPerformed
        ...
        Date anoAtual1 = new Date();
        SimpleDateFormat formato = new SimpleDateFormat("yyyy");
        String aux = formato.format(anoAtual1);
        int anoAtual2 = Integer.parseInt(aux);
        int idade = anoAtual2 - ano;
